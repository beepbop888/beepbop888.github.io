# Where the card pictures come from

Every picture in this app — the ones bundled here and the thousands
on `beepbop888.github.io/cards` — is a **public-domain or CC0** work
from a museum that publishes its open-access collection: no
attribution required, free for commercial use. That is the whole
reason these three collections and not stock photography: a greeting
card is forwarded by whoever sends it, into a family chat where there
is nowhere honest to put an attribution string.

Fetched and curated by `python tools/fetch_card_library.py`. The
museum record behind every picture is linked below, and the same
fields travel in the manifest for the pictures that are not bundled.

| picture | title | artist | collection |
|---|---|---|---|
| `a9eba119f79d` | Tree branches in the spring (Unsplash) | Tim McCartney timmccartney | [commons](61643878) |
...
| `b2107e772658` | Salix caprea (flowering male catkin) | Волков В.П. | [commons](15436011) |
...
| `afc36d871e07` | Начало зимы в Карелии. Beginning of winter in Karelia | Eniisi Lisika | [commons](148837734) |
| `4f79a46c9392` | 213Libad Festival procession Guagua Pampanga 16 | Judgefloro | [commons](64914378) |
| `33152ca95b31` | Shakopee Lantern Light Festival - Dragon Oct 2017 2 | Thomson200 | [commons](63319411) |
| `202183206dd2` | Central Park Winter, The Skating Carnival - Currier & Ives, undated, hand-colored lithograph - Albany Institute of History and Art - DSC08210 | Daderot | [commons](30271865) |
| `a4b8754768a4` | Festival in Piazza Navona | Giovanni Paolo Panini | [Art Institute of Chicago](https://www.artic.edu/artworks/111667) |
| `d94be7631558` | Bouquet of Sunflowers MET DP130800 | Claude Monet | [commons](57670809) |
| `03bd8fc4ba9d` | Flower Vase (Unsplash) | Math builtbymath | [commons](61710013) |
...
| `f23ad22cac72` | Evening view of La Rosière from below Arc 1950, 2018 | DimiTalen | [commons](158673911) |
| `b0356a41f6d2` | Sunset and stars over Stångehuvud | W.carter | [commons](88363564) |
...
| `0a68646be390` | 08290-Portland, Ore.-1906-Moonlight on the Willamette River-Brück & Sohn Kunstverlag | Brück &amp; Sohn Kunstverlag Meißen | [commons](52604703) |
